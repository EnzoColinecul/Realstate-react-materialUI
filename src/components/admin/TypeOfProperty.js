...
function TypeOfProperty(props) {
    const { typeOfProperty, handleChange, valueRadioCasas } = props

    if (typeOfProperty === 'Casas') {
        return (
            <RadioGroup name="unit" onChange={handleChange} value={valueRadioCasas} defaultValue="Casa" row color="primary">
        ...
        return (
            <RadioGroup name="unit" onChange={handleChange} value={valueRadioCasas} defaultValue="Departamento" row color="primary">
